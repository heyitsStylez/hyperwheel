...
- **Built artifacts** (all gitignored):
  - HyperWheel → `hyperwheel.html` (local) + `public/index.html` (Vercel `/`)
  - Wheeler → `wheeler.html` (local) + `public/wheeler/index.html` (Vercel `/wheeler`)
...
public/index.html         # HyperWheel for Vercel (/) — gitignored, built on deploy
wheeler.html              # Wheeler artifact — gitignored
public/wheeler/index.html # Wheeler for Vercel (/wheeler) — gitignored
